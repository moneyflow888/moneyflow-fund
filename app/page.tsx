...
import { Card, Metric, THEME, PIE_PALETTE } from "@/components/mf/MfUi";
...
export default function Page() {
  ...
  const allocRawTotal = useMemo(() => allocRaw.reduce((acc, r) => acc + num(r.value_usdt), 0), [allocRaw]);
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-2 text-sm" style={{ color: THEME.muted }}>
                ...
                {snapshotId ? (
                  <span className="ml-3 text-xs" style={{ color: THEME.muted }}>
                    Snapshot ID：<span style={{ color: THEME.text, fontWeight: 700 }}>{snapshotId}</span>
                  </span>
                ) : null}
              </div>
            </div>
                    ...
                    <div key={r.category} className="flex items-center justify-between text-sm">
                      <div className="flex flex-col">
                        ...
                        <div className="text-xs" style={{ color: THEME.muted }}>
                          pnl_now <span style={{ color: toneNow, fontWeight: 700 }}>{fmtSigned(r.pnl_now)}</span> ｜ 24h{" "}
                          <span style={{ color: tone24, fontWeight: 700 }}>{fmtSigned(r.pnl_24h)}</span> ｜ WTD{" "}
