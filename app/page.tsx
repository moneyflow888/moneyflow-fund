...
export default function Page() {
  ...
  const snapshotId = (pool as any)?.snapshot_id ?? null;
  ...
  return (
    <Shell>
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        {/* ✅ 右上角：只留 Investor Login + Reload（已移除 Admin） */}
                  ...
                  <div key={r.category} className="flex items-center justify-between text-sm">
                    <div className="flex flex-col">
                      ...
                      <div className="text-xs" style={{ color: THEME.muted }}>
                        pnl_now{" "}
                        <span style={{ color: toneNow, fontWeight: 700 }}>{fmtSigned(r.pnl_now)}</span> ｜ 24h{" "}
